...
# 			python3 -m training.train_lsnpc \
# 			--batch_size 32 \
# 			--clf_name $pretrained \
# 			--dataset $dataset \
# 			--lr 2e-5 \
...
# 			--semi_sup true \
# 			--noisy_val false \
# 			--result_dir './trained_models/lsnpc_semi/' \
...
# 			--img_encoder $img_encoder \
# 			--semi_sup false \
# 			--result_dir './trained_models/lsnpc/' \
# 			--pretrained_clf ${pretrained_clf} \
# 			--n_repeats 5 \
# 			--grad_norm 2 \
# 			--eval_test_at_final_loop_only true \
