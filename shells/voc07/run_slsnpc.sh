...
do 
	...
	do
		...
		do 
			...
			do
			pretrained_clf=$(ls ../NoisyLabelCorrection/trained_models/${pretrained}/${dataset}_${noise_type}_${noise}_${img_encoder}_ep20_rd0/*.pth)
			echo "Using pretrained classifier ${pretrained_clf}"

			accelerate launch --mixed_precision=bf16 \
            -m training.train_slsnpc \
			--batch_size 32 \
			--clf_name $pretrained \
			--dataset $dataset \
			--lr 1e-5 \
			...
			--semi_sup false \
			--result_dir './trained_models/slsnpc/' \
