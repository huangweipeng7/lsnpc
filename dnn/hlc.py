""" 
Source: https://github.com/xiaoboxia/HLC/blob/main/gcn_ours.py 
"""
import torch
...
class ADD_GCN(nn.Module):
    def __init__(self, model, emb_size, num_classes):
        ...
        self.fc = nn.Conv2d(emb_size, num_classes, (1,1), bias=False)
...
def get_model(encoder, emb_size, num_classes):
    #encoder = resnet50(weights=ResNet50_Weights.DEFAULT)
    model = model_dict['ADD_GCN'](encoder, emb_size, num_classes)
    return model
